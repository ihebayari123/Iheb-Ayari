...
void initenigme(enigme *e){
    e->anim[0] =IMG_Load("inigme img/corr1.png");
    e->anim[1] =IMG_Load("inigme img/corr2.png");
    e->anim[2] =IMG_Load("inigme img/corr3.png");
    e->bgenigme = IMG_Load("inigme img/bgc2.jpg");
}
void afficherEnigme(enigme e, SDL_Surface *screen) {
    SDL_Surface *image = IMG_Load("inigme img/bgc2.jpg");
    if (image == NULL) {
    ...
    TTF_Font *font = TTF_OpenFont("inigme img/pixelmix.ttf", 16);
    if (font == NULL) {
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        SDL_Rect reponseRect = {180, 230 + i * 50};
...
void animerEnig(enigme *e, SDL_Surface *screen) {
    ...
    SDL_Rect destRect = {200, 300, 0, 0}; // Adjust this rect as needed

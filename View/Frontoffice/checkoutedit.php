...
try {
    // Vérifie si un ID est fourni dans l'URL ou dans le formulaire
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $order_id = intval($_POST['id']); // Récupère l'ID à partir du formulaire
    } elseif (isset($_GET['id'])) {
        $order_id = intval($_GET['id']); // Récupère l'ID à partir de l'URL
    } else {
    ...
    if (!$order) {
        throw new Exception("Commande non trouvée pour l'ID : $order_id");
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Checkout Summary</a></li>
                        <li class="breadcrumb-item active">Modifier la commande</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        <div class="title-left">
                            <h3>Modification du commande</h3>
                        </div>
                        <form method="POST" action="checkoutedit.php" onsubmit="return validateOrderForm()">
